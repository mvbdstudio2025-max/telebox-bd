...
const trendingIds = [2061, 2060, 2059, 2058, 2057, 2056, 2050, 2049, 2048, 2031, 2030, 2029, 2028, 2026, 2025, 2024, 2023, 2022, 2021, 2020, 2019,]
  ...
  return (
    <section className="px-4 py-2">
      <div className="relative flex justify-center -mt-4 mb-0">
        ...
        <img
          src="https://i.postimg.cc/W45x0Jy7/photo-2026-02-27-17-32-47-removebg-preview.png"
